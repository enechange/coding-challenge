...
class Api::V1::PlansControllerTepcoTest < ActionDispatch::IntegrationTest
  ...
  test "電力会社名が正しいこと" do
    ...
    assert_equal plan["provider_name"], "東京電力エナジーパートナー"
  end

  test "プラン名が正しいこと" do
    get api_v1_plans_index_url, params: { ampere: 10, amount: 0 }
    plan = plan_from_response_body(@provider_name , response.body)
    assert_equal plan["plan_name"], "従量電灯B"
  end
  ...
  test "10Aの基本料金と『120kWhをこえ300kWhまで（121kWh）』の場合,3491円を返すこと" do
  ...
  # 286 + 26.48 * 300 = 8230 
  test "10Aの基本料金と『120kWhをこえ300kWhまで（300kWh）』の場合,8230円を返すこと" do
  ...
  test "10Aの基本料金と『300kWhをこえる分（301kWh）』の場合,9488円を返すこと" do
  ...
  test "15Aの基本料金と『120kWhをこえ300kWhまで（121kWh）』の場合,3634円を返すこと" do
  ...
  # 429 + 26.48 * 300 = 8373
  test "15Aの基本料金と『120kWhをこえ300kWhまで（300kWh）』の場合,8373円を返すこと" do
  ...
  test "15Aの基本料金と『300kWhをこえる分（301kWh）』の場合,9631円を返すこと" do
  ...
  test "20Aの基本料金と『120kWhをこえ300kWhまで（121kWh）』の場合,3777円を返すこと" do
  ...
  # 572 + 26.48 * 300 = 8516
  test "20Aの基本料金と『120kWhをこえ300kWhまで（300kWh）』の場合,8516円を返すこと" do
  ...
  test "20Aの基本料金と『300kWhをこえる分（301kWh）』の場合,9774円を返すこと" do
  ...
  test "30Aの基本料金と『300kWhをこえる分（301kWh）』の場合,10060円を返すこと" do
  ...
  test "40Aの基本料金と『300kWhをこえる分（301kWh）』の場合,10346円を返すこと" do
  ...
  test "50Aの基本料金と『300kWhをこえる分（301kWh）』の場合,10632円を返すこと" do
  ...
  # 1716 + 26.48 * 300 = 9660
  test "60Aの基本料金と『120kWhをこえ300kWhまで（300kWh）』の場合,9660円を返すこと" do
  ...
  test "60Aの基本料金と『300kWhをこえる分（301kWh）』の場合,10918円を返すこと" do
