...
class Api::V1::PlansControllerTokyogasTest < ActionDispatch::IntegrationTest
  ...
  test "30Aの基本料金と『最初の140kWhをこえ350kWhまで（141kWh）』の場合,4226円を返すこと" do
  ...
  # 858 + 23.88 * 350 = 9216
  test "30Aの基本料金と『最初の140kWhをこえ350kWhまで（350kWh）』の場合,9216円を返すこと" do
  ...
  test "30Aの基本料金と『最初の350kWhをこえる分（351kWh）』の場合,10128円を返すこと" do
  ...
  test "40Aの基本料金と『最初の140kWhをこえ350kWhまで（141kWh）』の場合,4512円を返すこと" do
  ...
  # 1144 + 23.88 * 300 = 9502
  test "40Aの基本料金と『最初の140kWhをこえ350kWhまで（350kWh）』の場合,9502円を返すこと" do
  ...
  test "40Aの基本料金と『最初の350kWhをこえる分（351kWh）』の場合,10414円を返すこと" do
  ...
  test "50Aの基本料金と『最初の140kWhをこえ350kWhまで（141kWh）』の場合,4798円を返すこと" do
  ...
  # 1430 + 23.88 * 350 = 9788
  test "50Aの基本料金と『最初の140kWhをこえ350kWhまで（350kWh）』の場合,9788円を返すこと" do
  ...
  test "50Aの基本料金と『最初の350kWhをこえる分（351kWh）』の場合,10700円を返すこと" do
  ...
  test "60Aの基本料金と『最初の140kWhをこえ350kWhまで（141kWh）』の場合,5084円を返すこと" do
  ...
  test "60Aの基本料金と『最初の140kWhをこえ350kWhまで（350kWh）』の場合,10074円を返すこと" do
  ...
  test "60Aの基本料金と『最初の350kWhをこえる分（351kWh）』の場合,10986円を返すこと" do
