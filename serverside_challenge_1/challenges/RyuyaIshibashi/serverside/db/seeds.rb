...
companies.each_with_index do |name, i|
  ...
  case i
  when 0
    BasicFee.create!(plan: plan, ampere: '10.00', fee: '286.00')
    BasicFee.create!(plan: plan, ampere: '15.00', fee: '429.00')
    BasicFee.create!(plan: plan, ampere: '20.00', fee: '572.00')
    BasicFee.create!(plan: plan, ampere: '30.00', fee: '858.00')
    BasicFee.create!(plan: plan, ampere: '40.00', fee: '1144.00')
    BasicFee.create!(plan: plan, ampere: '50.00', fee: '1430.00')
    BasicFee.create!(plan: plan, ampere: '60.00', fee: '1716.00')
  ...
  when 1
    BasicFee.create!(plan: plan, ampere: '10.00', fee: '0.00')
    BasicFee.create!(plan: plan, ampere: '15.00', fee: '0.00')
    BasicFee.create!(plan: plan, ampere: '20.00', fee: '0.00')
    BasicFee.create!(plan: plan, ampere: '30.00', fee: '0.00')
    BasicFee.create!(plan: plan, ampere: '40.00', fee: '0.00')
    BasicFee.create!(plan: plan, ampere: '50.00', fee: '0.00')
    BasicFee.create!(plan: plan, ampere: '60.00', fee: '0.00')
  ...
  when 3
    ...
    BasicFee.create!(plan: plan, ampere: '40.00', fee: '1144.00')
    BasicFee.create!(plan: plan, ampere: '50.00', fee: '1430.00')
    BasicFee.create!(plan: plan, ampere: '60.00', fee: '1716.80')
